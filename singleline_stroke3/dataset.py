...
# %% auto 0
__all__ = ['enumerate_files', 'svgs_to_deltas', 'stroke_summary_df', 'split_train_val']
...
def split_train_val(full_dataset, output_fname, split_ratio=0.8, max_strokes=None):
