# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_svg.ipynb.

# %% auto 0
__all__ = ['discretize_svg', 'to_points', 'discretize_path', 'discretize_paths', 'rescale_strokes', 'global_svg_transform',
           'parse_svg', 'svg_to_transforms', 'parse_transform_instruction', 'build_transforms']
